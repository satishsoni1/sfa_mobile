...
class BbaDetailScreen extends StatefulWidget {
  final Map<String, dynamic> brand;
  final int? targetUserId;
  final bool readOnly;
  const BbaDetailScreen({
    super.key,
    required this.brand,
    this.targetUserId,
    this.readOnly = false,
  ...
  @override
  State<BbaDetailScreen> createState() => _BbaDetailScreenState();
}

class _BbaDetailScreenState extends State<BbaDetailScreen> {
